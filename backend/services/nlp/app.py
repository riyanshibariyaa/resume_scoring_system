...
class ResumeExtractor:
    ...
    def _extract_experience(self, text: str, sections: List[Dict]) -> List[Dict[str, Any]]:
        ...
        for line in lines:
            line = line.strip()
            if not line or line.lower() in ['experience', 'work experience', 'employment']:
                continue
            ...
            if dates:
                ...
                title_company = self._extract_title_company(line)
                current_exp['title'] = title_company['title']
                current_exp['company'] = title_company['company']
                
            elif current_exp:
                # Add to description
                if line.startswith(('•', '-', '*')) or re.match(r'^\d+[\.\)]', line):
                    current_exp['description'].append(line.lstrip('•-*0123456789.) '))
                else:
    ...
    def _load_skills_ontology(self) -> Dict[str, Dict[str, Any]]:
        """Load skills ontology with aliases and categories"""
        return {
            'Python': {
                'aliases': ['Python', 'Python3', 'Python 3', 'python'],
                'category': 'programming_languages'
            },
            'JavaScript': {
                'aliases': ['JavaScript', 'JS', 'Javascript', 'ECMAScript'],
                'category': 'programming_languages'
            },
            'Java': {
                'aliases': ['Java', 'java'],
            ...
            'SQL': {
                'aliases': ['SQL', 'sql', 'T-SQL', 'PL/SQL'],
                'category': 'programming_languages'
            },
            'React': {
                'aliases': ['React', 'ReactJS', 'React.js', 'react'],
                'category': 'frameworks'
            },
            'Angular': {
                'aliases': ['Angular', 'AngularJS', 'angular'],
                'category': 'frameworks'
            },
            'Vue.js': {
                'aliases': ['Vue', 'Vue.js', 'VueJS', 'vue'],
                'category': 'frameworks'
            },
            '.NET': {
            ...
            'PostgreSQL': {
                'aliases': ['PostgreSQL', 'Postgres', 'postgres'],
                'category': 'databases'
            },
            'MySQL': {
                'aliases': ['MySQL', 'mysql'],
            ...
            'MongoDB': {
                'aliases': ['MongoDB', 'Mongo', 'mongodb'],
                'category': 'databases'
            },
            'SQL Server': {
                'aliases': ['SQL Server', 'MS SQL', 'MSSQL', 'Microsoft SQL Server'],
                'category': 'databases'
            },
            'Redis': {
                'aliases': ['Redis', 'redis'],
            ...
            'Git': {
                'aliases': ['Git', 'git', 'GitHub', 'GitLab'],
                'category': 'tools'
            },
            'AWS': {
                'aliases': ['AWS', 'Amazon Web Services', 'aws'],
                'category': 'cloud'
            },
            'Azure': {
            ...
            'Machine Learning': {
                'aliases': ['Machine Learning', 'ML', 'machine learning'],
                'category': 'other'
            },
            'Deep Learning': {
            ...
            'NLP': {
                'aliases': ['NLP', 'Natural Language Processing', 'nlp'],
                'category': 'other'
            },
        }
